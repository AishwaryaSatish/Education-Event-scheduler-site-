...
<?php
 ...
 {
 	mysqli_query($link,"INSERT into registeration values ('$_POST[t1]','$_POST[t2]','$_POST[t3]',
 ...
 {
 	mysqli_query($link,"DELETE FROM registeration where usn='$_POST[t1]' ");
}
if(isset($_POST["submit3"])){
echo "<script> alert('you can view the information'); window.location.assign('http://localhost/DBMS PROJECT/admin_view.php');</script>";
}
